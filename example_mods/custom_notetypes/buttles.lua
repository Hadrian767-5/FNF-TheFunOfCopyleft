function onCreate()
	...
	for i = 0, getProperty('unspawnNotes.length')-1 do
		if getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'buttles' then
			setPropertyFromGroup('unspawnNotes', i, 'texture', 'buttles');
...
function goodNoteHit(id, noteData, noteType, isSustainNote)
	...
	if noteType == "buttles" and noteData == 1 then
		characterPlayAnim('BF','dodge',false)
		characterPlayAnim('Dad','shoot',false)
	end
	
	if noteType == "buttles" and noteData == 2 then
		characterPlayAnim('BF','dodge',false)
		characterPlayAnim('Dad','shoot',false)
	end
	
	if noteType == "buttles" and noteData == 3 then
		characterPlayAnim('BF','dodge',false)
		characterPlayAnim('Dad','shoot',false)
	end
end
