function onCreatePost()
    ...
    makeLuaText('upText', '上', 60, getProperty('upButton.x'), getProperty('upButton.y') + 20)
    ...
    makeLuaText('downText', '下', 60, getProperty('downButton.x'), getProperty('downButton.y') + 20)
    ...
    makeLuaText('leftText', '左', 60, getProperty('leftButton.x') + 2, getProperty('leftButton.y') + 20)
    ...
    makeLuaText('rightText', '右', 65, getProperty('rightButton.x') - 2, getProperty('rightButton.y') + 20)
